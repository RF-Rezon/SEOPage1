    ...
    <>
      <div className="rounded-[4px] bg-white mb-3 mx-2">
        <div className="py-1 px-2">
            ...
            <div className="w-[70%]">
              <div className="flex items-center">
                ...
                <p className="text-gray-500 font-semibold text-[12px] truncate">
                  ...
                  Inventore, facilis obcaecati? Assumenda delectus rem velit
                  ipsa aspernatur! In, molestiae voluptatem?
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-x-[14px] text-gray-600 font-bold text-[12px] py-2">
            <div className="h-6 w-6 rounded-full">
              <img
                src={Rejon}
                alt="user pic"
            ...
            <div className="flex items-center gap-x-1">
             ...
             <Modal singleCard={singleCard} />
              <p className="">{singleCard?.attatchfiles?.length}</p>
            </div>
            <div className="flex items-center gap-x-1">
              <div className="cursor-pointer">
                <FaCalendarAlt />
